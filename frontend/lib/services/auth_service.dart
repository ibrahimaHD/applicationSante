  ...
  Future<AuthResult> register(Map<String, dynamic> donnees) async {
    try {
      ...
      final body = {
        ...
        if (donnees['numero_licence'] != null)
          'numero_ordre': donnees['numero_licence'],
        if (donnees['hopital_clinique'] != null)
          'hopital_clinique': donnees['hopital_clinique'],
        if (donnees['diplome_url'] != null)
          'diplome_url': donnees['diplome_url'],
        if (donnees['document_identite_url'] != null)
          'document_identite_url': donnees['document_identite_url'],
        // Champs pharmacien
        if (donnees['nom_pharmacie'] != null)
          'nom_pharmacie': donnees['nom_pharmacie'],
        if (donnees['adresse_pharmacie'] != null)
          'adresse_pharmacie': donnees['adresse_pharmacie'],
        if (donnees['nom_pharmacie'] != null &&
            donnees['numero_licence'] != null)
          'numero_licence': donnees['numero_licence'],
        // Champs livreur
        if (donnees['vehicle_type'] != null)
          'vehicule': donnees['vehicle_type'],
        if (donnees['zone'] != null) 'zone_livraison': donnees['zone'],
        if (donnees['numero_permis'] != null)
      ...
      await _ajouterFichier(
          request, 'document_identite', donnees['document_identite']);
      await _ajouterFichier(
          request, 'autorisation_exercice', donnees['autorisation_exercice']);
      await _ajouterFichier(
          request, 'permis_conduire', donnees['permis_conduire']);
