...
class LivraisonsScreen extends StatefulWidget {
  ...
  @override
  State<LivraisonsScreen> createState() => _LivraisonsState();
}
...
class _LivraisonsState extends State<LivraisonsScreen> {
  ...
  Future<void> _charger() async {
    ...
    try {
      ...
      if (rp.statusCode == 200) {
        ...
        setState(() => _disponible = dp['profil']?['disponible'] == true ||
            dp['profil']?['disponible'] == 1);
      }
    } catch (e) {
      debugPrint('charger livraisons: $e');
    }
  ...
  Future<void> _majStatut(Map<String, dynamic> livraison, String statut) async {
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              backgroundColor: statut == 'livree'
                  ? AppColors.success
                  : const Color(0xFFF4511E),
              foregroundColor: Colors.white,
            ),
            child:
                Text(statut == 'livree' ? 'Confirmer livraison' : 'Démarrer'),
          ),
        ],
      ),
    );
    ...
    try {
      final r = await http.patch(
        Uri.parse(
            '${AppConstants.baseUrl}/livreur/livraisons/${livraison['id']}'),
        headers: await _headers(),
  ...
  String _statutLabel(String s) {
    switch (s) {
      ...
      case 'en_preparation':
        return 'Préparation';
      case 'en_livraison':
        return 'À récupérer / en livraison';
      case 'livree':
        return 'Livrée ✓';
      default:
        return s;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Livraisons du jour",
            style: TextStyle(
                color: Colors.white,
                fontSize: 16,
        ...
        Container(
          ...
          child: Column(children: [
            ...
            Container(
              ...
              child: Row(children: [
                Icon(_disponible ? Icons.circle : Icons.circle_outlined,
                    color: _disponible ? Colors.greenAccent : Colors.white60,
                    size: 12),
              ...
              : _livraisons.isEmpty
                  ? Center(
                      child: Column(
                          ...
                          const Text("Aucune livraison aujourd'hui",
                              style: TextStyle(
                                    ...
                                    child: Row(children: [
                                      ...
                                      Expanded(
                                          child: Column(
                                            ...
                                            Text(
                                                '${l['patient_prenom'] ?? ''} ${l['patient_nom'] ?? ''}',
                                                style: const TextStyle(
                                                    fontSize: 12,
                                                    color: AppColors
                                                        .textSecondary)),
                                    ...
                                    child: Column(children: [
                                      Row(children: [
                                        const Icon(Icons.location_on_outlined,
                                            size: 16, color: Color(0xFFF4511E)),
